...
{
  size_t grain = 4;
  if (properties.major <= 1) grain = 1;
  if (properties.major <= 5) grain = 2;
  return grain;
}
...
{
  size_t n = 8;
  if (properties.major > 2) n = 16;
  if (properties.major > 7) n = 32;
  return n;
}
                                            ...
                                            size_t dynamic_smem_bytes)
{
  ...
  //////////////////////////////////////////
  //printf("ctaLimitRegs=%ld, ctaLimitSMem=%ld, ctaLimitThreads=%ld, ctaLimitBlocks=%ld\n", ctaLimitRegs, ctaLimitSMem, ctaLimitThreads, ctaLimitBlocks);
